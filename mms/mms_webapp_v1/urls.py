...
urlpatterns = [
	...
	url(r'^user/user=(?P<user_id>\w+)/activity/$', login_required(UserActivityListView.as_view()), name='user_activity_list_view_v1'),
	...
	url(r'^organization_type/organization_type=(?P<organization_type_id>\w+)/$', login_required(OrganizationTypeDetailView.as_view()),name='organization_type_detail_view_v1'),

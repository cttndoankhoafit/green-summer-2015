    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.PositiveSmallIntegerField(default=2, null=True, verbose_name='Lo\u1ea1i ho\u1ea1t \u0111\u1ed9ng', choices=[(0, 'Nh\u1eadn th\u1ee9c'), (1, 'H\xe0nh \u0111\u1ed9ng'), (2, 'Kh\xe1c')])),
                ('start_time', models.DateTimeField(default=None, null=True, blank=True)),
                ('end_time', models.DateTimeField(default=None, null=True, blank=True)),
                ('published_time', models.DateTimeField(default=None, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('state', models.PositiveSmallIntegerField(default=7, null=True, verbose_name='Tr\u1ea1ng th\xe1i', choices=[(0, 'Qu\u1ea3n tr\u1ecb'), (1, 'Ban t\u1ed5 ch\u1ee9c'), (2, 'C\u1ed9ng t\xe1c vi\xean'), (3, '\u0110\xe3 tham gia'), (4, '\u0110\xe3 \u0111\u0103ng k\xfd'), (5, 'R\xe8n luy\u1ec7n \u0110o\xe0n vi\xean'), (6, 'R\xe8n luy\u1ec7n H\u1ed9i vi\xean'), (7, 'Kh\xf4ng tham gia')])),
                ('activity', models.ForeignKey(to='mms_backoffice.Activity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', models.CharField(default=None, max_length=2048, null=True, blank=True)),
                ('organization_manager', models.ForeignKey(default=None, blank=True, to='mms_backoffice.Organization', null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('state', models.PositiveSmallIntegerField(default=3, null=True, verbose_name='Tr\u1ea1ng th\xe1i', choices=[(0, 'Qu\u1ea3n tr\u1ecb'), (1, 'C\xe1n b\u1ed9 ch\u1ee7 ch\u1ed1t'), (2, 'C\xe1n b\u1ed9'), (3, 'Th\xe0nh vi\xean')])),
                ('details', models.CharField(default=None, max_length=2048, null=True, blank=True)),
